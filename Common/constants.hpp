...
// Tray icon GUID
static constexpr GUID TRAY_GUID = {0x2EA4687, 0xE0EC, 0x4B84, {0x9B, 0x68, 0xBD, 0x1B, 0xB4, 0xCC, 0xD2, 0x24}};
...
static constexpr Util::null_terminated_wstring_view WM_TTBHOOKTASKVIEWVISIBILITYCHANGE =
    L"TTBHook_TaskViewVisibilityChange";
