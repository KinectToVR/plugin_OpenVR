...
using PFN_NT_QUERY_SYSTEM_INFORMATION = __kernel_entry NTSTATUS(NTAPI*)(
    IN SYSTEM_INFORMATION_CLASS SystemInformationClass, OUT PVOID SystemInformation, IN ULONG SystemInformationLength,
