...
static constexpr CLSID CLSID_ImmersiveShell = {
    0xC2F03A33, 0x21F5, 0x47FA, {0xB4, 0xBB, 0x15, 0x63, 0x62, 0xA2, 0xF2, 0x39}
};
static constexpr GUID SID_MultitaskingViewVisibilityService = {
    0x785702DD, 0xB8EF, 0x469F, {0x8C, 0x19, 0xE9, 0x1B, 0x5F, 0x4C, 0xA5, 0x64}
};
...
enum MULTITASKING_VIEW_TYPES : INT
{
    ...
    MVT_PPI_ALL_UP_VIEW = 0x8,
    // this is used by Windows 10 Team, so not of interest to us
    MVT_ANY = 0xF
};
...
{
public:
    virtual HRESULT STDMETHODCALLTYPE IsViewVisible(MULTITASKING_VIEW_TYPES flags, MULTITASKING_VIEW_TYPES* retFlags) =
    0;
    virtual HRESULT STDMETHODCALLTYPE Register(IMultitaskingViewVisibilityNotification* pVisibilityNotification,
                                               DWORD* pdwCookie) = 0;
