...
namespace Util
{
    ...
    class basic_null_terminated_string_view : public std::basic_string_view<char_type, traits>
    {
        ...
        constexpr basic_null_terminated_string_view(const typename base::const_pointer str,
                                                    const typename base::size_type length) noexcept :
            base(str, length)
        {
        }
    ...
    public:
        ...
        static constexpr basic_null_terminated_string_view make_unsafe(const typename base::const_pointer str,
                                                                       const typename base::size_type length) noexcept
        {
            return {str, length};
        }
...
struct std::formatter<Util::basic_null_terminated_string_view<char_type, traits>,
                      char_type> : std::formatter<std::basic_string_view<char_type, traits>, char_type>
{
};
