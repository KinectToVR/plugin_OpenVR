...
struct OptionalTaskbarAppearance : TaskbarAppearance
{
    ...
    constexpr OptionalTaskbarAppearance(bool enabled, ACCENT_STATE accent, Util::Color color, bool showPeek,
                                        bool showLine) noexcept :
...
protected:
    void OptionalInnerDeserialize(std::wstring_view key, const rjh::value_t& val,
