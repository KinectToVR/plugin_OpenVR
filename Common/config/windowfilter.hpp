...
struct WindowFilter
{
    ...
    WindowFilter(std::unordered_set<std::wstring> classList, std::unordered_set<std::wstring> titleList,
                 win32::FilenameSet fileList) :
...
private:
    ...
    inline static void SerializeStringSet(Writer& writer,
                                          const std::unordered_set<std::wstring, Hash, Equal, Alloc>& set,
    ...
    inline static void DeserializeStringSet(const rjh::value_t& arr,
                                            std::unordered_set<std::wstring, Hash, Equal, Alloc>& set,
                                            std::wstring_view key)
    {
